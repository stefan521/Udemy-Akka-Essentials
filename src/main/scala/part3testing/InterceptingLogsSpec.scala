...
// the intercepting of logs messages in very useful in integration tests

class InterceptingLogsSpec extends TestKit(ActorSystem(
  ...
  "A checkout flow" should {
    "correctly log the dispatch of an order" in {
      EventFilter.info( // scans for log messages at level info
